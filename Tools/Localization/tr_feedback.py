...
T("Request a new Feature/ Report a Bug",
  ...
  "Proponi una funzione / Segnala un bug",
  "Sugerir um recurso / Relatar um erro",
  "Functie voorstellen / Bug melden",
  "Предложить функцию / Сообщить об ошибке",
  "Zaproponuj funkcję / Zgłoś błąd",
  "Özellik öner / Hata bildir",
...
T("Write to the developer: report something that's broken, ask for a feature, or say what you make of the app.",
  ...
  "Écrivez au développeur : signalez un problème, demandez une fonctionnalité ou dites ce que vous pensez de l’appli.",
  "Scrivi allo sviluppatore: segnala un problema, chiedi una funzione o di’ cosa pensi dell’app.",
  "Escreva para o desenvolvedor: relate um problema, peça um recurso ou diga o que achou do app.",
  "Schrijf de ontwikkelaar: meld iets dat stuk is, vraag om een functie of zeg wat je van de app vindt.",
  "Напишите разработчику: сообщите об ошибке, попросите функцию или расскажите, что думаете о приложении.",
  "Napisz do twórcy: zgłoś błąd, poproś o funkcję albo powiedz, co sądzisz o aplikacji.",
  "Geliştiriciye yaz: bir hatayı bildir, bir özellik iste ya da uygulama hakkında ne düşündüğünü söyle.",
...
T("What the message is: something that's broken, something you'd like added, what you make of the app, or something you'd like to know.",
  ...
  "Ce dont il s’agit : quelque chose qui ne marche pas, quelque chose que vous aimeriez voir ajouté, votre avis sur l’appli, ou une question.",
  "Di cosa si tratta: qualcosa non funziona, qualcosa che vorresti aggiunto, la tua opinione sull’app o una domanda.",
  "Do que se trata a mensagem: algo com defeito, algo que você gostaria que fosse adicionado, sua opinião sobre o app ou uma dúvida.",
  "Waar het over gaat: iets dat stuk is, iets dat je erbij wilt, wat je van de app vindt, of iets dat je wilt weten.",
  "О чём сообщение: что-то не работает, чего-то не хватает, ваше мнение о приложении или вопрос.",
  "Czego dotyczy wiadomość: coś nie działa, czegoś brakuje, opinia o aplikacji albo pytanie.",
  "Mesajın konusu: bozuk bir şey, eklenmesini istediğin bir şey, uygulama hakkındaki görüşün ya da bir soru.",
...
T("Optional. The tab your message is about, so it's clear where to look.",
  ...
  "Facultatif. L’onglet concerné par votre message, pour savoir où chercher.",
  "Facoltativo. La scheda a cui si riferisce il messaggio, così è chiaro dove guardare.",
  "Opcional. A aba a que sua mensagem se refere, para saber onde procurar.",
  "Optioneel. Het tabblad waar je bericht over gaat, zodat duidelijk is waar te kijken.",
  "Необязательно. Вкладка, о которой идёт речь, чтобы было понятно, где искать.",
  "Opcjonalnie. Karta, której dotyczy wiadomość, żeby wiadomo było, gdzie szukać.",
  "İsteğe bağlı. Mesajının ilgili olduğu sekme, nereye bakılacağı belli olsun diye.",
...
T("Optional, and only needed if you'd like an answer. Left blank, your message is still read.",
  ...
  "Facultatif, utile seulement si vous souhaitez une réponse. Sans adresse, votre message est lu quand même.",
  "Facoltativo, serve solo se vuoi una risposta. Se lo lasci vuoto, il messaggio viene letto lo stesso.",
  "Opcional, só é necessário se você quiser uma resposta. Em branco, sua mensagem é lida do mesmo jeito.",
  "Optioneel, alleen nodig als je antwoord wilt. Leeg gelaten wordt je bericht nog steeds gelezen.",
  "Необязательно, нужно только если вы хотите получить ответ. Без адреса сообщение всё равно будет прочитано.",
  "Opcjonalnie, potrzebne tylko wtedy, gdy chcesz odpowiedź. Puste pole nie przeszkadza — wiadomość i tak zostanie przeczytana.",
  "İsteğe bağlı, yalnızca yanıt istiyorsan gerekir. Boş bırakırsan mesajın yine de okunur.",
...
T("Required for a question, since there's no way to answer you without it.",
  ...
  "Obligatoire pour une question, car sans adresse il n’y a aucun moyen de vous répondre.",
  "Obbligatorio per una domanda, perché senza indirizzo non c’è modo di risponderti.",
  "Obrigatório para uma pergunta, porque sem endereço não há como responder a você.",
  "Verplicht bij een vraag, want zonder adres is er geen manier om je te antwoorden.",
  "Обязательно для вопроса: без адреса ответить вам не получится.",
  "Wymagane przy pytaniu, bo bez adresu nie da się odpowiedzieć.",
  "Bir soru için zorunlu, çünkü adres olmadan sana yanıt verilemez.",
...
T("That doesn't look like an e-mail address.",
  ...
  "Non sembra un indirizzo e-mail.",
  "Isso não parece um endereço de e-mail.",
  "Dat lijkt geen e-mailadres.",
  "Это не похоже на адрес эл. почты.",
  "To nie wygląda na adres e-mail.",
  "Bu bir e-posta adresine benzemiyor.",
...
T("Write a message before sending.",
  ...
  "Escreva uma mensagem antes de enviar.", "Schrijf een bericht voordat je verstuurt.",
...
T("Add your e-mail address before sending.",
  ...
  "Inserisci il tuo indirizzo e-mail prima di inviare.",
  "Informe seu e-mail antes de enviar.",
  "Vul je e-mailadres in voordat je verstuurt.",
  "Перед отправкой укажите адрес эл. почты.",
  "Przed wysłaniem podaj swój adres e-mail.",
  "Göndermeden önce e-posta adresini yaz.",
...
T("Your message couldn't be sent. Check your connection and try again.",
  ...
  "Je bericht kon niet worden verstuurd. Controleer je verbinding en probeer het opnieuw.",
