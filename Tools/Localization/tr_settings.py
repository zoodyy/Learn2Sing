...
T("Microphone", "Mikrofon", "Micrófono", "Micro", "Microfono", "Microfone", "Microfoon", "Микрофон", "Mikrofon", "Mikrofon", "Mikrofon", "マイク", "마이크", "麦克风")
T("Automatic", "Automatisch", "Automático", "Automatique", "Automatico", "Automático", "Automatisch", "Автоматически", "Automatycznie", "Otomatik", "Automatiskt", "自動", "자동", "自动")
...
T("Pitch of the Recording", "Tonhöhe der Aufnahme", "Tono de la grabación", "Hauteur de l’enregistrement", "Altezza della registrazione", "Altura da gravação", "Toonhoogte van de opname", "Высота записи", "Wysokość nagrania", "Kaydın perdesi", "Inspelningens tonhöjd", "録音の音高", "녹음의 음높이", "录音的音高")
T("e.g. C3 or 130.81", "z. B. C3 oder 130.81", "p. ej. C3 o 130.81", "p. ex. C3 ou 130.81", "es. C3 o 130.81", "por ex. C3 ou 130.81", "bijv. C3 of 130.81", "например, C3 или 130.81", "np. C3 lub 130.81", "ör. C3 veya 130.81", "t.ex. C3 eller 130.81", "例: C3 または 130.81", "예: C3 또는 130.81", "例如 C3 或 130.81")
...
T("Interpreted as", "Erkannt als", "Interpretado como", "Interprété comme", "Interpretato come", "Interpretado como", "Gelezen als", "Распознано как", "Odczytano jako", "Şu şekilde yorumlandı", "Tolkas som", "解釈結果", "인식된 값", "识别为")
T("Not recognized", "Nicht erkannt", "No reconocido", "Non reconnu", "Non riconosciuto", "Não reconhecido", "Niet herkend", "Не распознано", "Nie rozpoznano", "Tanınmadı", "Känns inte igen", "認識できません", "인식할 수 없음", "无法识别")
T("Use for Playback", "Für Wiedergabe verwenden", "Usar para la reproducción", "Utiliser pour la lecture", "Usa per la riproduzione", "Usar na reprodução", "Gebruiken voor afspelen", "Использовать для воспроизведения", "Użyj do odtwarzania", "Çalma için kullan", "Använd vid uppspelning", "再生に使用", "재생에 사용", "用于播放")
T("Delete Instrument", "Instrument löschen", "Eliminar instrumento", "Supprimer l’instrument", "Elimina strumento", "Excluir instrumento", "Instrument verwijderen", "Удалить инструмент", "Usuń instrument", "Enstrümanı sil", "Radera instrument", "楽器を削除", "악기 삭제", "删除乐器")
T("Delete Instrument?", "Instrument löschen?", "¿Eliminar el instrumento?", "Supprimer l’instrument ?", "Eliminare lo strumento?", "Excluir instrumento?", "Instrument verwijderen?", "Удалить инструмент?", "Usunąć instrument?", "Enstrüman silinsin mi?", "Radera instrumentet?", "楽器を削除しますか？", "악기를 삭제할까요?", "要删除该乐器吗？")
...
# --- Voice ---
T("Vocal Range", "Stimmumfang", "Tesitura", "Tessiture", "Estensione vocale", "Extensão vocal", "Stembereik", "Диапазон голоса", "Skala głosu", "Ses aralığı", "Röstomfång", "声域", "음역대", "音域")
T("Vocal range", "Stimmumfang", "Tesitura", "Tessiture", "Estensione vocale", "Extensão vocal", "Stembereik", "Диапазон голоса", "Skala głosu", "Ses aralığı", "Röstomfång", "声域", "음역대", "音域")
T("Not set", "Nicht festgelegt", "Sin definir", "Non défini", "Non impostato", "Não definido", "Niet ingesteld", "Не задан", "Nie ustawiono", "Ayarlanmadı", "Ej angivet", "未設定", "설정 안 됨", "未设置")
T("Lowest note", "Tiefster Ton", "Nota más grave", "Note la plus grave", "Nota più bassa", "Nota mais grave", "Laagste noot", "Самая низкая нота", "Najniższy dźwięk", "En pes nota", "Lägsta ton", "最低音", "최저음", "最低音")
T("Highest note", "Höchster Ton", "Nota más aguda", "Note la plus aiguë", "Nota più alta", "Nota mais aguda", "Hoogste noot", "Самая высокая нота", "Najwyższy dźwięk", "En tiz nota", "Högsta ton", "最高音", "최고음", "最高音")
T("Test Vocal Range", "Stimmumfang testen", "Probar la tesitura", "Tester la tessiture", "Testa l’estensione vocale", "Testar extensão vocal", "Stembereik testen", "Проверить диапазон", "Zbadaj skalę głosu", "Ses aralığını test et", "Testa röstomfång", "声域をテスト", "음역대 테스트", "测试音域")
...
T("How long you mean to practise a day. The Home tab's “Recommended” category suggests exercises adding up to at least this long — favouring the whitelisted ones you haven't practised in the longest, pitched at your skill level — and a day of the Home tab's “Time Spent Singing” is filled in and ticked once you have practised this much.",
  "Wie lange du am Tag üben möchtest. Die Kategorie „Empfohlen“ im Start-Tab schlägt Übungen vor, die zusammen mindestens so lange dauern — bevorzugt die zugelassenen, die du am längsten nicht geübt hast, abgestimmt auf dein Niveau — und ein Tag in „Gesungene Zeit“ im Start-Tab wird ausgefüllt und bekommt einen Haken, sobald du so lange geübt hast.",
  "Cuánto tiempo quieres practicar al día. La categoría «Recomendado» de la pestaña Inicio sugiere ejercicios que sumen al menos ese tiempo —dando preferencia a los permitidos que llevas más tiempo sin practicar, ajustados a tu nivel— y un día de «Tiempo cantado» de la pestaña Inicio se rellena y recibe una marca en cuanto has practicado ese tiempo.",
  "Combien de temps vous comptez travailler par jour. La catégorie « Recommandé » de l’onglet Accueil propose des exercices dont la durée totale atteint au moins ce temps — en privilégiant les exercices autorisés que vous n’avez pas travaillés depuis le plus longtemps, adaptés à votre niveau — et un jour de « Temps de chant » de l’onglet Accueil se remplit et reçoit une coche dès que vous avez travaillé aussi longtemps.",
  "Quanto tempo vuoi esercitarti al giorno. La categoria “Consigliati” della scheda Home propone esercizi che insieme durano almeno altrettanto — prediligendo quelli ammessi che non pratichi da più tempo, calibrati sul tuo livello — e un giorno di “Tempo cantato” nella scheda Home si riempie e riceve un segno di spunta quando ti sei esercitato per questo tempo.",
  "Quanto tempo você pretende praticar por dia. A categoria “Recomendado” da aba Início sugere exercícios que somem pelo menos esse tempo — preferindo os permitidos que você não pratica há mais tempo, ajustados ao seu nível — e um dia de “Tempo cantado” da aba Início é preenchido e ganha um tique assim que você praticar tudo isso.",
  "Hoe lang je per dag wilt oefenen. De categorie ‘Aanbevolen’ op het tabblad Start stelt oefeningen voor die samen minstens zo lang duren — met voorrang voor de toegestane oefeningen die je het langst niet hebt geoefend, afgestemd op je niveau — en een dag in ‘Gezongen tijd’ op het tabblad Start wordt ingekleurd en krijgt een vinkje zodra je zo lang hebt geoefend.",
  "Сколько времени в день вы собираетесь заниматься. Категория «Рекомендуемые» на вкладке «Главная» предлагает упражнения, которые в сумме длятся не меньше этого времени — предпочтение отдаётся разрешённым, которыми вы дольше всего не занимались, подобранным под ваш уровень, — а день в разделе «Время пения» на вкладке «Главная» закрашивается и отмечается галочкой, как только вы позанимались столько.",
  "Ile czasu dziennie chcesz ćwiczyć. Kategoria „Polecane” na karcie Start proponuje ćwiczenia, które razem trwają co najmniej tyle — preferując te dozwolone, których najdłużej nie ćwiczyłeś, dobrane do twojego poziomu — a dzień w kategorii „Czas śpiewania” na karcie Start zostaje wypełniony i oznaczony haczykiem, gdy tyle poćwiczysz.",
  "Günde ne kadar çalışmayı düşündüğünüz. Ana Sayfa sekmesindeki “Önerilen” kategorisi, toplamda en az bu kadar süren egzersizler önerir — en uzun süredir çalışmadığınız, izin verilen egzersizleri seviyenize göre öne çıkararak — ve Ana Sayfa sekmesindeki “Şarkı söyleme süresi”nde bir gün, bu kadar çalıştığınızda dolar ve onay işareti alır.",
  "Hur länge du tänker öva per dag. Kategorin ”Rekommenderat” på fliken Hem föreslår övningar som tillsammans räcker minst så länge — den föredrar de tillåtna övningar du övat på för längst sedan, anpassade till din nivå — och en dag i ”Sångtid” på fliken Hem fylls i och får en bock så snart du har övat så länge.",
  "1日にどれくらい練習するかです。ホームタブの「おすすめ」カテゴリは、合計でこの時間以上になるエクササイズを提案します（対象のエクササイズのうち最も長く練習していないものを優先し、あなたのレベルに合わせて選びます）。ホームタブの「歌った時間」の各日は、この時間だけ練習するとぬりつぶされ、チェックマークが付きます。",
  "하루에 얼마나 연습할지입니다. 홈 탭의 “추천” 카테고리는 합쳐서 최소 이만큼 걸리는 연습을 제안하며(허용된 연습 중 가장 오래 연습하지 않은 것을 우선하고, 나의 레벨에 맞춰 고릅니다), 홈 탭 “노래한 시간”의 하루는 이만큼 연습하면 색이 채워지고 체크 표시가 붙습니다.",
  "你打算每天练习多长时间。“首页”标签中的“推荐”类别会建议加起来至少这么长的练习——优先挑选你最久没有练习过的已列入练习，并按你的水平来选——“首页”标签的“歌唱时长”中，某一天练满这么久后就会被填满并打上对勾。")
