...
T("How many exercises the Home tab's “Recommended” category suggests. It favours the whitelisted exercises you haven't practised in the longest, pitched at your skill level.",
  "Wie viele Übungen die Kategorie „Empfohlen“ im Start-Tab vorschlägt. Bevorzugt werden die zugelassenen Übungen, die du am längsten nicht geübt hast, abgestimmt auf dein Niveau.",
  "Cuántos ejercicios sugiere la categoría «Recomendado» de la pestaña Inicio. Da preferencia a los ejercicios permitidos que llevas más tiempo sin practicar, ajustados a tu nivel.",
  "Le nombre d’exercices proposés par la catégorie « Recommandé » de l’onglet Accueil. Elle privilégie les exercices autorisés que vous n’avez pas travaillés depuis le plus longtemps, adaptés à votre niveau.",
  "Quanti esercizi propone la categoria “Consigliati” della scheda Home. Predilige gli esercizi ammessi che non pratichi da più tempo, calibrati sul tuo livello.",
  "Quantos exercícios a categoria “Recomendado” da aba Início sugere. Ela prefere os exercícios permitidos que você não pratica há mais tempo, ajustados ao seu nível.",
  "Hoeveel oefeningen de categorie ‘Aanbevolen’ op het tabblad Start voorstelt. Het geeft voorrang aan de toegestane oefeningen die je het langst niet hebt geoefend, afgestemd op je niveau.",
  "Сколько упражнений предлагает категория «Рекомендуемые» на вкладке «Главная». Предпочтение отдаётся разрешённым упражнениям, которыми вы дольше всего не занимались, подобранным под ваш уровень.",
  "Ile ćwiczeń proponuje kategoria „Polecane” na karcie Start. Preferuje te dozwolone ćwiczenia, których najdłużej nie ćwiczyłeś, dobrane do twojego poziomu.",
  "Ana Sayfa sekmesindeki “Önerilen” kategorisinin kaç egzersiz önereceği. En uzun süredir çalışmadığınız, izin verilen egzersizleri seviyenize göre öne çıkarır.",
  "Hur många övningar kategorin ”Rekommenderat” på fliken Hem föreslår. Den föredrar de tillåtna övningar du övat på för längst sedan, anpassade till din nivå.",
