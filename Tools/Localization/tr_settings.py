...
T("Your vocal range, the test that measures it, how quickly your pitch line follows your voice, and how precisely you have to hit a note for it to count.",
  "Dein Stimmumfang, der Test, der ihn misst, wie schnell deine Tonhöhenlinie deiner Stimme folgt, und wie genau du eine Note treffen musst, damit sie zählt.",
  "Tu tesitura, la prueba que la mide, con qué rapidez tu línea de tono sigue a tu voz y con cuánta precisión debes acertar una nota para que cuente.",
  "Votre tessiture, le test qui la mesure, la rapidité avec laquelle votre ligne de hauteur suit votre voix et la précision avec laquelle vous devez atteindre une note pour qu’elle compte.",
  "La tua estensione vocale, il test che la misura, quanto velocemente la tua linea dell’intonazione segue la tua voce e con quanta precisione devi centrare una nota perché conti.",
  "Sua extensão vocal, o teste que a mede, com que rapidez sua linha de altura acompanha sua voz e com que precisão você precisa acertar uma nota para que ela conte.",
  "Je stembereik, de test die het meet, hoe snel je toonhoogtelijn je stem volgt en hoe nauwkeurig je een noot moet raken om te tellen.",
  "Ваш диапазон голоса, тест, который его измеряет, то, насколько быстро линия высоты тона следует за голосом, и то, насколько точно нужно попасть в ноту, чтобы она засчиталась.",
  "Twoja skala głosu, test, który ją mierzy, to, jak szybko linia wysokości dźwięku podąża za głosem, i to, jak dokładnie trzeba trafić nutę, żeby się liczyła.",
  "Ses aralığınız, onu ölçen test, perde çizginizin sesinizi ne kadar hızlı takip ettiği ve bir notanın sayılması için ne kadar isabetli söylemeniz gerektiği.",
  "Ditt röstomfång, testet som mäter det, hur snabbt din tonhöjdslinje följer din röst och hur exakt du måste träffa en ton för att den ska räknas.",
  "あなたの声域、それを測定するテスト、ピッチの線が声にどれだけ速く追従するか、そして音符が当たりとみなされる正確さ。",
  "음역대, 이를 측정하는 테스트, 음정 선이 목소리를 얼마나 빨리 따라가는지, 그리고 음표가 인정되려면 얼마나 정확히 맞혀야 하는지.",
  "你的音域、测量音域的测试、音高线跟随你声音的速度，以及唱中一个音符需要多准确才会计分。",
  "مداك الصوتي، والاختبار الذي يقيسه، ومدى سرعة تتبّع خط درجة الصوت لصوتك، ومدى الدقة المطلوبة لإصابة النغمة حتى تُحتسب.")
...
T("Pitch Detection", "Tonhöhenerkennung", "Detección de tono", "Détection de hauteur", "Rilevamento dell’intonazione", "Detecção de altura", "Toonhoogtedetectie", "Определение высоты тона", "Wykrywanie wysokości dźwięku", "Perde algılama", "Tonhöjdsavläsning", "ピッチ検出", "음정 인식", "音高识别", "اكتشاف درجة الصوت")
T("Fastest, jittery", "Am schnellsten, unruhig", "Más rápida, inestable", "La plus rapide, instable", "La più veloce, instabile", "Mais rápida, instável", "Snelst, onrustig", "Самое быстрое, дёрганое", "Najszybsze, niespokojne", "En hızlı, titrek", "Snabbast, ryckig", "最速・揺れやすい", "가장 빠름, 불안정", "最快，易抖动", "الأسرع، متذبذب")
T("Balanced delay and accuracy", "Ausgewogen zwischen Verzögerung und Genauigkeit", "Equilibrio entre retraso y precisión", "Équilibre entre délai et précision", "Equilibrio tra ritardo e precisione", "Equilíbrio entre atraso e precisão", "Evenwicht tussen vertraging en nauwkeurigheid", "Баланс задержки и точности", "Równowaga opóźnienia i dokładności", "Gecikme ve doğruluk dengeli", "Balans mellan fördröjning och noggrannhet", "遅延と正確さのバランス", "지연과 정확도의 균형", "延迟与准确度平衡", "توازن بين التأخير والدقة")
T("Slowest, most accurate", "Am langsamsten, am genauesten", "Más lenta, más precisa", "La plus lente, la plus précise", "La più lenta, la più precisa", "Mais lenta, mais precisa", "Traagst, nauwkeurigst", "Самое медленное, самое точное", "Najwolniejsze, najdokładniejsze", "En yavaş, en doğru", "Långsammast, noggrannast", "最も遅い・最も正確", "가장 느림, 가장 정확", "最慢，最准确", "الأبطأ، الأدق")
T("How quickly your pitch line follows your voice. The slower choices wait a moment to see what comes next, so consonants and mouth sounds throw the line off less, and your score allows for the wait.",
  "Wie schnell deine Tonhöhenlinie deiner Stimme folgt. Die langsameren Optionen warten einen Moment ab, was als Nächstes kommt, damit Konsonanten und Mundgeräusche die Linie weniger aus der Bahn werfen, und deine Punktzahl berücksichtigt die Wartezeit.",
  "Con qué rapidez tu línea de tono sigue a tu voz. Las opciones más lentas esperan un momento para ver lo que viene después, así que las consonantes y los ruidos de la boca desvían menos la línea, y tu puntuación tiene en cuenta la espera.",
  "La rapidité avec laquelle votre ligne de hauteur suit votre voix. Les choix plus lents attendent un instant de voir ce qui suit, si bien que les consonnes et les bruits de bouche dévient moins la ligne, et votre note tient compte de l’attente.",
  "Quanto velocemente la tua linea dell’intonazione segue la tua voce. Le scelte più lente aspettano un attimo per vedere cosa viene dopo, così consonanti e rumori della bocca disturbano meno la linea, e il punteggio tiene conto dell’attesa.",
  "Com que rapidez sua linha de altura acompanha sua voz. As opções mais lentas esperam um instante para ver o que vem a seguir, então consoantes e ruídos da boca atrapalham menos a linha, e sua pontuação leva a espera em conta.",
  "Hoe snel je toonhoogtelijn je stem volgt. De langzamere keuzes wachten even af wat er daarna komt, zodat medeklinkers en mondgeluiden de lijn minder van slag brengen, en je score houdt rekening met het wachten.",
  "Насколько быстро линия высоты тона следует за вашим голосом. Более медленные варианты немного ждут, чтобы увидеть, что будет дальше, поэтому согласные и звуки рта меньше сбивают линию, а оценка учитывает это ожидание.",
  "Jak szybko linia wysokości dźwięku podąża za twoim głosem. Wolniejsze opcje czekają chwilę, by zobaczyć, co będzie dalej, więc spółgłoski i odgłosy ust mniej zakłócają linię, a wynik uwzględnia to oczekiwanie.",
  "Perde çizginizin sesinizi ne kadar hızlı takip ettiği. Daha yavaş seçenekler sırada ne geldiğini görmek için kısa bir süre bekler; böylece ünsüzler ve ağız sesleri çizgiyi daha az bozar ve puanınız bu beklemeyi hesaba katar.",
  "Hur snabbt din tonhöjdslinje följer din röst. De långsammare valen väntar ett ögonblick för att se vad som kommer härnäst, så att konsonanter och munljud stör linjen mindre, och dina poäng tar hänsyn till väntan.",
  "ピッチの線が声にどれだけ速く追従するか。遅い選択肢は次に来る音を少し待ってから描くため、子音や口の音で線が乱れにくくなり、採点ではその待ち時間が考慮されます。",
  "음정 선이 목소리를 얼마나 빨리 따라가는지 정합니다. 느린 선택지는 다음에 오는 소리를 잠시 기다렸다 그리므로 자음이나 입소리에 선이 덜 흔들리며, 점수는 그 기다림을 반영합니다.",
  "音高线跟随你声音的速度。较慢的选项会稍等片刻，看清接下来的声音再画，因此辅音和口腔杂音不太会打乱这条线，评分也会把这段等待考虑在内。",
  "مدى سرعة تتبّع خط درجة الصوت لصوتك. تنتظر الخيارات الأبطأ لحظة لترى ما يأتي بعد ذلك، فتقلّ إزاحة الحروف الساكنة وأصوات الفم للخط، وتأخذ نتيجتك هذا الانتظار في الحسبان.")
T("Draws your pitch as soon as it is heard, about 15 ms after you sing it. Consonants and mouth sounds show up in the line as jumps and short wrong notes.",
  "Zeichnet deine Tonhöhe, sobald sie zu hören ist, etwa 15 ms nachdem du sie singst. Konsonanten und Mundgeräusche erscheinen in der Linie als Sprünge und kurze falsche Noten.",
  "Dibuja tu tono en cuanto se oye, unos 15 ms después de que lo cantes. Las consonantes y los ruidos de la boca aparecen en la línea como saltos y notas erróneas breves.",
  "Dessine votre hauteur dès qu’elle est entendue, environ 15 ms après que vous la chantez. Les consonnes et les bruits de bouche apparaissent dans la ligne sous forme de sauts et de brèves fausses notes.",
  "Disegna la tua intonazione appena si sente, circa 15 ms dopo che la canti. Consonanti e rumori della bocca compaiono nella linea come salti e brevi note sbagliate.",
  "Desenha sua altura assim que ela é ouvida, cerca de 15 ms depois de você cantá-la. Consoantes e ruídos da boca aparecem na linha como saltos e notas erradas curtas.",
  "Tekent je toonhoogte zodra die te horen is, ongeveer 15 ms nadat je hem zingt. Medeklinkers en mondgeluiden verschijnen in de lijn als sprongen en korte verkeerde noten.",
  "Рисует высоту тона, как только она слышна, примерно через 15 мс после того, как вы её спели. Согласные и звуки рта появляются на линии как скачки и короткие неверные ноты.",
  "Rysuje wysokość dźwięku, gdy tylko ją słychać, około 15 ms po tym, jak ją zaśpiewasz. Spółgłoski i odgłosy ust pojawiają się na linii jako skoki i krótkie błędne nuty.",
  "Perdenizi duyulur duyulmaz, söyledikten yaklaşık 15 ms sonra çizer. Ünsüzler ve ağız sesleri çizgide sıçramalar ve kısa yanlış notalar olarak görünür.",
  "Ritar din tonhöjd så snart den hörs, cirka 15 ms efter att du sjunger den. Konsonanter och munljud syns i linjen som hopp och korta felaktiga toner.",
  "音程が聞こえた瞬間、歌ってから約15ミリ秒後に描きます。子音や口の音は、線の跳ねや短い誤った音として現れます。",
  "음정이 들리는 즉시, 부른 뒤 약 15밀리초 후에 그립니다. 자음과 입소리가 선에 튀는 부분이나 짧은 틀린 음으로 나타납니다.",
  "一听到音高就画出来，大约在你唱出后 15 毫秒。辅音和口腔杂音会在线上显示为跳动和短暂的错音。",
  "يرسم درجة صوتك فور سماعها، بعد نحو 15 مللي ث من غنائك لها. تظهر الحروف الساكنة وأصوات الفم في الخط على شكل قفزات ونغمات خاطئة قصيرة.")
T("Draws your pitch about 35 ms after you sing it. Short wrong readings, and most of the slide a consonant puts at the start and end of a syllable, are left out.",
  "Zeichnet deine Tonhöhe etwa 35 ms nachdem du sie singst. Kurze Fehlmessungen und der größte Teil des Rutschers, den ein Konsonant an Anfang und Ende einer Silbe erzeugt, werden weggelassen.",
  "Dibuja tu tono unos 35 ms después de que lo cantes. Se omiten las lecturas erróneas breves y la mayor parte del deslizamiento que una consonante provoca al principio y al final de una sílaba.",
  "Dessine votre hauteur environ 35 ms après que vous la chantez. Les brèves mesures erronées et l’essentiel du glissement qu’une consonne provoque au début et à la fin d’une syllabe sont laissés de côté.",
  "Disegna la tua intonazione circa 35 ms dopo che la canti. Le brevi letture errate e la maggior parte dello scivolamento che una consonante provoca all’inizio e alla fine di una sillaba vengono tralasciate.",
  "Desenha sua altura cerca de 35 ms depois de você cantá-la. Leituras erradas curtas e a maior parte do deslize que uma consoante causa no início e no fim de uma sílaba ficam de fora.",
  "Tekent je toonhoogte ongeveer 35 ms nadat je hem zingt. Korte foute metingen en het grootste deel van de glijder die een medeklinker aan het begin en eind van een lettergreep veroorzaakt, worden weggelaten.",
  "Рисует высоту тона примерно через 35 мс после того, как вы её спели. Короткие ошибочные измерения и большая часть скольжения, которое согласная вызывает в начале и в конце слога, не показываются.",
  "Rysuje wysokość dźwięku około 35 ms po tym, jak ją zaśpiewasz. Krótkie błędne odczyty i większość poślizgu, jaki spółgłoska wywołuje na początku i końcu sylaby, są pomijane.",
  "Perdenizi söyledikten yaklaşık 35 ms sonra çizer. Kısa yanlış ölçümler ve bir ünsüzün hecenin başında ve sonunda yarattığı kaymanın çoğu gösterilmez.",
  "Ritar din tonhöjd cirka 35 ms efter att du sjunger den. Korta felavläsningar och det mesta av glidningen som en konsonant ger i början och slutet av en stavelse utelämnas.",
  "歌ってから約35ミリ秒後に音程を描きます。短い誤検出や、子音が音節の始めと終わりに生むずれの大部分は表示されません。",
  "부른 뒤 약 35밀리초 후에 음정을 그립니다. 짧은 잘못된 측정값과, 자음이 음절의 시작과 끝에 만드는 미끄러짐의 대부분은 표시하지 않습니다.",
  "在你唱出后约 35 毫秒画出音高。短暂的错误读数，以及辅音在音节开头和结尾造成的滑动的大部分，都不会显示。",
  "يرسم درجة صوتك بعد نحو 35 مللي ث من غنائك لها. تُستبعد القراءات الخاطئة القصيرة ومعظم الانزلاق الذي يُحدثه الحرف الساكن في بداية المقطع ونهايته.")
T("Draws your pitch about 95 ms after you sing it. The line stays on the note you are holding through consonants such as “t”, “k” and “s”, and wrong readings are left out.",
  "Zeichnet deine Tonhöhe etwa 95 ms nachdem du sie singst. Die Linie bleibt bei Konsonanten wie „t“, „k“ und „s“ auf der Note, die du hältst, und Fehlmessungen werden weggelassen.",
  "Dibuja tu tono unos 95 ms después de que lo cantes. La línea se mantiene en la nota que sostienes a través de consonantes como «t», «k» y «s», y se omiten las lecturas erróneas.",
  "Dessine votre hauteur environ 95 ms après que vous la chantez. La ligne reste sur la note que vous tenez malgré les consonnes comme « t », « k » et « s », et les mesures erronées sont laissées de côté.",
  "Disegna la tua intonazione circa 95 ms dopo che la canti. La linea resta sulla nota che stai tenendo anche con consonanti come “t”, “k” e “s”, e le letture errate vengono tralasciate.",
  "Desenha sua altura cerca de 95 ms depois de você cantá-la. A linha fica na nota que você está sustentando mesmo com consoantes como “t”, “k” e “s”, e leituras erradas ficam de fora.",
  "Tekent je toonhoogte ongeveer 95 ms nadat je hem zingt. De lijn blijft op de noot die je aanhoudt, ook bij medeklinkers als ‘t’, ‘k’ en ‘s’, en foute metingen worden weggelaten.",
  "Рисует высоту тона примерно через 95 мс после того, как вы её спели. Линия остаётся на ноте, которую вы тянете, даже на согласных вроде «т», «к» и «с», а ошибочные измерения не показываются.",
  "Rysuje wysokość dźwięku około 95 ms po tym, jak ją zaśpiewasz. Linia zostaje na nucie, którą trzymasz, także przy spółgłoskach takich jak „t”, „k” i „s”, a błędne odczyty są pomijane.",
  "Perdenizi söyledikten yaklaşık 95 ms sonra çizer. Çizgi, “t”, “k” ve “s” gibi ünsüzlerde de tuttuğunuz notada kalır ve yanlış ölçümler gösterilmez.",
  "Ritar din tonhöjd cirka 95 ms efter att du sjunger den. Linjen stannar på tonen du håller även vid konsonanter som ”t”, ”k” och ”s”, och felavläsningar utelämnas.",
  "歌ってから約95ミリ秒後に音程を描きます。「t」「k」「s」のような子音があっても線は伸ばしている音にとどまり、誤検出は表示されません。",
  "부른 뒤 약 95밀리초 후에 음정을 그립니다. ‘t’, ‘k’, ‘s’ 같은 자음에서도 선이 지금 내고 있는 음에 머무르며, 잘못된 측정값은 표시하지 않습니다.",
  "在你唱出后约 95 毫秒画出音高。即使遇到“t”“k”“s”这样的辅音，线也会停留在你正在唱的音上，错误读数也不会显示。",
  "يرسم درجة صوتك بعد نحو 95 مللي ث من غنائك لها. يبقى الخط على النغمة التي تمدّها حتى مع حروف ساكنة مثل «ت» و«ك» و«س»، وتُستبعد القراءات الخاطئة.")
...
# The alert an import puts up when public exercises it would have kept public
# break the rules for public exercises and are made private instead.
T("Exercise Made Private", "Übung ist jetzt privat", "El ejercicio ahora es privado", "Exercice rendu privé", "Esercizio reso privato", "Exercício agora é privado", "Oefening privé gemaakt", "Упражнение стало личным", "Ćwiczenie ustawiono jako prywatne", "Egzersiz özel yapıldı", "Övningen gjordes privat", "エクササイズを非公開にしました", "비공개로 전환된 연습", "练习已设为私有", "أصبح التمرين خاصًا")
T("Exercises Made Private", "Übungen sind jetzt privat", "Los ejercicios ahora son privados", "Exercices rendus privés", "Esercizi resi privati", "Exercícios agora são privados", "Oefeningen privé gemaakt", "Упражнения стали личными", "Ćwiczenia ustawiono jako prywatne", "Egzersizler özel yapıldı", "Övningarna gjordes privata", "エクササイズを非公開にしました", "비공개로 전환된 연습", "练习已设为私有", "أصبحت التمارين خاصة")
T("This exercise was public, but its imported version doesn't meet the rules for public exercises, so it is now private. You can find it on the Exercises tab.",
  "Diese Übung war öffentlich, aber ihre importierte Fassung erfüllt die Regeln für öffentliche Übungen nicht, deshalb ist sie jetzt privat. Du findest sie im Übungen-Tab.",
  "Este ejercicio era público, pero su versión importada no cumple las reglas de los ejercicios públicos, así que ahora es privado. Lo encontrarás en la pestaña Ejercicios.",
  "Cet exercice était public, mais sa version importée ne respecte pas les règles des exercices publics : il est donc désormais privé. Vous le trouverez dans l’onglet Exercices.",
  "Questo esercizio era pubblico, ma la sua versione importata non rispetta le regole per gli esercizi pubblici, quindi ora è privato. Lo trovi nella scheda Esercizi.",
  "Este exercício era público, mas a versão importada não atende às regras dos exercícios públicos, então agora ele é privado. Você o encontra na aba Exercícios.",
  "Deze oefening was openbaar, maar de geïmporteerde versie voldoet niet aan de regels voor openbare oefeningen, dus hij is nu privé. Je vindt hem op het tabblad Oefeningen.",
  "Это упражнение было публичным, но его импортированная версия не соответствует правилам для публичных упражнений, поэтому теперь оно личное. Его можно найти на вкладке «Упражнения».",
  "To ćwiczenie było publiczne, ale jego zaimportowana wersja nie spełnia zasad dla publicznych ćwiczeń, więc jest teraz prywatne. Znajdziesz je na karcie Ćwiczenia.",
  "Bu egzersiz herkese açıktı, ancak içe aktarılan sürümü herkese açık egzersizlerin kurallarını karşılamadığı için artık özel. Onu Egzersizler sekmesinde bulabilirsin.",
  "Den här övningen var offentlig, men den importerade versionen uppfyller inte reglerna för offentliga övningar, så den är nu privat. Du hittar den på fliken Övningar.",
  "このエクササイズは公開されていましたが、読み込んだバージョンが公開エクササイズのルールを満たしていないため、非公開になりました。エクササイズタブで確認できます。",
  "이 연습은 공개 상태였지만, 가져온 버전이 공개 연습의 규칙을 충족하지 않아 비공개로 전환되었습니다. 연습 탭에서 찾을 수 있습니다.",
  "该练习原为公开，但导入的版本不符合公开练习的规则，因此现已设为私有。你可以在“练习”标签中找到它。",
  "كان هذا التمرين عامًا، لكن نسخته المستوردة لا تستوفي قواعد التمارين العامة، لذلك أصبح خاصًا الآن. ستجده في تبويب التمارين.")
T("These exercises were public, but their imported versions don't meet the rules for public exercises, so they are now private. You can find them on the Exercises tab.",
  "Diese Übungen waren öffentlich, aber ihre importierten Fassungen erfüllen die Regeln für öffentliche Übungen nicht, deshalb sind sie jetzt privat. Du findest sie im Übungen-Tab.",
  "Estos ejercicios eran públicos, pero sus versiones importadas no cumplen las reglas de los ejercicios públicos, así que ahora son privados. Los encontrarás en la pestaña Ejercicios.",
  "Ces exercices étaient publics, mais leurs versions importées ne respectent pas les règles des exercices publics : ils sont donc désormais privés. Vous les trouverez dans l’onglet Exercices.",
  "Questi esercizi erano pubblici, ma le loro versioni importate non rispettano le regole per gli esercizi pubblici, quindi ora sono privati. Li trovi nella scheda Esercizi.",
  "Estes exercícios eram públicos, mas as versões importadas não atendem às regras dos exercícios públicos, então agora eles são privados. Você os encontra na aba Exercícios.",
  "Deze oefeningen waren openbaar, maar de geïmporteerde versies voldoen niet aan de regels voor openbare oefeningen, dus ze zijn nu privé. Je vindt ze op het tabblad Oefeningen.",
  "Эти упражнения были публичными, но их импортированные версии не соответствуют правилам для публичных упражнений, поэтому теперь они личные. Их можно найти на вкладке «Упражнения».",
  "Te ćwiczenia były publiczne, ale ich zaimportowane wersje nie spełniają zasad dla publicznych ćwiczeń, więc są teraz prywatne. Znajdziesz je na karcie Ćwiczenia.",
  "Bu egzersizler herkese açıktı, ancak içe aktarılan sürümleri herkese açık egzersizlerin kurallarını karşılamadığı için artık özel. Onları Egzersizler sekmesinde bulabilirsin.",
  "De här övningarna var offentliga, men de importerade versionerna uppfyller inte reglerna för offentliga övningar, så de är nu privata. Du hittar dem på fliken Övningar.",
  "これらのエクササイズは公開されていましたが、読み込んだバージョンが公開エクササイズのルールを満たしていないため、非公開になりました。エクササイズタブで確認できます。",
  "이 연습들은 공개 상태였지만, 가져온 버전이 공개 연습의 규칙을 충족하지 않아 비공개로 전환되었습니다. 연습 탭에서 찾을 수 있습니다.",
  "这些练习原为公开，但导入的版本不符合公开练习的规则，因此现已设为私有。你可以在“练习”标签中找到它们。",
  "كانت هذه التمارين عامة، لكن نسخها المستوردة لا تستوفي قواعد التمارين العامة، لذلك أصبحت خاصة الآن. ستجدها في تبويب التمارين.")
T("Shorter than %@, counting all repetitions:",
  "Kürzer als %@, alle Wiederholungen zusammen:",
  "Menos de %@ sumando todas las repeticiones:",
  "Moins de %@, toutes répétitions confondues :",
  "Meno di %@ contando tutte le ripetizioni:",
  "Menos de %@ somando todas as repetições:",
  "Korter dan %@, alle herhalingen samen:",
  "Короче %@ со всеми повторами вместе:",
  "Krótsze niż %@ łącznie ze wszystkimi powtórzeniami:",
  "Tüm tekrarlarıyla birlikte %@ süreden kısa olanlar:",
  "Kortare än %@ med alla repetitioner sammanlagt:",
  "繰り返しをすべて合わせて%@未満のもの：",
  "모든 반복을 합쳐 %@ 미만:",
  "所有重复加在一起不足 %@：",
  "أقصر من %@، باحتساب جميع التكرارات:")
T("Name already used by another of your public exercises:",
  "Name schon von einer anderen deiner öffentlichen Übungen verwendet:",
  "Nombre ya usado por otro de tus ejercicios públicos:",
  "Nom déjà utilisé par un autre de vos exercices publics :",
  "Nome già usato da un altro dei tuoi esercizi pubblici:",
  "Nome já usado por outro dos seus exercícios públicos:",
  "Naam al gebruikt door een andere openbare oefening van je:",
  "Название уже занято другим вашим публичным упражнением:",
  "Nazwa zajęta już przez inne twoje publiczne ćwiczenie:",
  "Adı, herkese açık başka bir egzersizinde zaten kullanılıyor:",
  "Namnet används redan av en annan av dina offentliga övningar:",
  "名前がほかの公開エクササイズで使われているもの：",
  "다른 공개 연습에서 이미 사용 중인 이름:",
  "名称已被你的另一个公开练习使用：",
  "الاسم مستخدم بالفعل في تمرين عام آخر لك:")
