...
T("Username \"%@\" is not available",
  ...
  "用户名“%@”不可用")
T("Profile Description", "Profilbeschreibung", "Descripción del perfil", "Description du profil", "Descrizione del profilo", "Descrição do perfil", "Profielbeschrijving", "Описание профиля", "Opis profilu", "Profil açıklaması", "Profilbeskrivning", "プロフィールの説明", "프로필 설명", "个人资料简介")
T("Write something about yourself", "Schreib etwas über dich", "Escribe algo sobre ti", "Écrivez quelque chose sur vous", "Scrivi qualcosa su di te", "Escreva algo sobre você", "Schrijf iets over jezelf", "Напишите что-нибудь о себе", "Napisz coś o sobie", "Kendiniz hakkında bir şeyler yazın", "Skriv något om dig själv", "自分について書いてください", "자신에 대해 써 보세요", "写点关于你自己的内容")
T("Make your join date public", "Beitrittsdatum öffentlich zeigen", "Hacer pública la fecha de registro", "Rendre publique la date d’inscription", "Rendi pubblica la data di iscrizione", "Tornar pública a data de entrada", "Aanmelddatum openbaar maken", "Показывать дату регистрации всем", "Pokazuj publicznie datę dołączenia", "Katılma tarihini herkese açık yap", "Gör ditt anslutningsdatum offentligt", "参加日を公開する", "가입 날짜 공개하기", "公开加入日期")

# --- Profile picture ---
T("Profile Picture", "Profilbild", "Foto de perfil", "Photo de profil", "Immagine del profilo", "Foto do perfil", "Profielfoto", "Фото профиля", "Zdjęcie profilowe", "Profil fotoğrafı", "Profilbild", "プロフィール写真", "프로필 사진", "个人头像")
T("Choose Photo", "Foto auswählen", "Elegir foto", "Choisir une photo", "Scegli foto", "Escolher foto", "Foto kiezen", "Выбрать фото", "Wybierz zdjęcie", "Fotoğraf seç", "Välj foto", "写真を選択", "사진 선택", "选择照片")
T("Change Photo", "Foto ändern", "Cambiar foto", "Changer de photo", "Cambia foto", "Alterar foto", "Foto wijzigen", "Изменить фото", "Zmień zdjęcie", "Fotoğrafı değiştir", "Byt foto", "写真を変更", "사진 변경", "更换照片")
T("Adjust Picture", "Bild anpassen", "Ajustar imagen", "Ajuster l’image", "Regola immagine", "Ajustar imagem", "Afbeelding aanpassen", "Настроить изображение", "Dopasuj zdjęcie", "Resmi ayarla", "Justera bild", "画像を調整", "사진 조정", "调整图片")
T("Remove Photo", "Foto entfernen", "Eliminar foto", "Supprimer la photo", "Rimuovi foto", "Remover foto", "Foto verwijderen", "Удалить фото", "Usuń zdjęcie", "Fotoğrafı kaldır", "Ta bort foto", "写真を削除", "사진 제거", "移除照片")
T("That photo could not be used.", "Dieses Foto konnte nicht verwendet werden.", "No se pudo usar esa foto.", "Cette photo n’a pas pu être utilisée.", "Impossibile usare quella foto.", "Não foi possível usar essa foto.", "Die foto kon niet worden gebruikt.", "Не удалось использовать это фото.", "Nie udało się użyć tego zdjęcia.", "Bu fotoğraf kullanılamadı.", "Det gick inte att använda det fotot.", "その写真は使用できませんでした。", "해당 사진을 사용할 수 없습니다.", "无法使用该照片。")
T("Drag and pinch to choose what shows in the circle.", "Ziehen und zoomen, um zu wählen, was im Kreis zu sehen ist.", "Arrastra y pellizca para elegir lo que se ve en el círculo.", "Faites glisser et pincez pour choisir ce qui apparaît dans le cercle.", "Trascina e pizzica per scegliere cosa si vede nel cerchio.", "Arraste e use o gesto de pinça para escolher o que aparece no círculo.", "Sleep en knijp om te kiezen wat er in de cirkel te zien is.", "Перетаскивайте и сводите пальцы, чтобы выбрать, что видно в круге.", "Przeciągaj i szczypnij, aby wybrać, co widać w kole.", "Dairede ne görüneceğini seçmek için sürükleyin ve parmaklarınızı kıstırın.", "Dra och nyp för att välja vad som syns i cirkeln.", "ドラッグとピンチで、円の中に表示する部分を選びます。", "드래그하고 손가락을 오므려 원 안에 보일 부분을 선택하세요.", "拖动并捏合以选择圆形中显示的部分。")
T("Close", "Schließen", "Cerrar", "Fermer", "Chiudi", "Fechar", "Sluiten", "Закрыть", "Zamknij", "Kapat", "Stäng", "閉じる", "닫기", "关闭")
